(() => {
  ...
  const CINEMAS = {
    plaza: {
      ...
      days: {
        '2026-06-19': [
          { time: '16:40', format: '2D Esp', hall: 'Sala Normal' },
          { time: '16:55', format: '2D Esp', hall: 'Sala Normal' },
          { time: '17:10', format: '2D Esp', hall: 'Pantalla Gigante MCX' },
          { time: '17:40', format: '2D Esp', hall: 'Sala Normal' },
          { time: '18:05', format: '3D Esp', hall: 'Sala Normal' },
          { time: '18:20', format: '2D Esp', hall: 'Sala Normal' },
          { time: '18:35', format: '2D Esp', hall: 'Pantalla Gigante MCX' },
          { time: '19:05', format: '2D Esp', hall: 'Sala Normal' },
          { time: '19:35', format: '2D Esp', hall: 'Pantalla Gigante MCX' },
          { time: '20:05', format: '2D Esp', hall: 'Sala Normal' },
          { time: '20:30', format: '3D Esp', hall: 'Sala Normal' },
          { time: '20:45', format: '2D Esp', hall: 'Sala Normal' },
          { time: '21:00', format: '2D Esp', hall: 'Pantalla Gigante MCX' },
        ],
      },
    },
  };
